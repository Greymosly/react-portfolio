...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://johnwgreenlaw.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  deleteImage(imageType) {
    axios
      ...
      .catch((error) => {
        console.log("deleteImage error", erorr);
      });
  }
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://johnwgreenlaw.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
